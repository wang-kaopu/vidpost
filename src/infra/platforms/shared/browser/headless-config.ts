 ...
 */
export const PLAYWRIGHT_HEADLESS_CONFIG: Record<PlaywrightHeadlessScenario, boolean> = {
  default: false,
  probe: false,
  'ping:douyin': true,
  'ping:bilibili': true,
 ...
 * @returns {boolean}
 */
export function resolvePlaywrightHeadlessMode(scenario: PlaywrightHeadlessScenario = 'default'): boolean {
